# Generated by Powerlevel10k configuration wizard on 2023-12-06 at 14:55 EET.
...
() {
  ...
  typeset -g VCS_STASHED_ICON='\uFB12 '
  typeset -g VCS_CONFILICTED_ICON='\uFC85 '
  typeset -g VCS_UNSTAGED_ICON='\uF718 '
  typeset -g VCS_STAGED_ICON='\uFC50 '
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}${(g::)VCS_STASHED_ICON}${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}${(g::)VCS_CONFLICTED_ICON}${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${(g::)VCS_STAGED_ICON}${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${(g::)VCS_UNSTAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
